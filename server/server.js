...
app.post('/challenges/:id/add-players', (req, res) => {
...
app.post('/challenges/:id/remove-players', (req, res) => {
...
app.post('/challenges/:id/add-actions', (req, res) => {
    const { id } = req.params;
...
app.get('/challenges/:id/players-actions', (req, res) => {
    console.log("AAAA\n\n")
    const { id } = req.params;
